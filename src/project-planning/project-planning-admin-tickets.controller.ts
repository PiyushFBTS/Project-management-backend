...
export class ProjectPlanningAdminTicketsController {
  ...
  addAssignee(
    ...
    return this.service.addTaskAssignee(taskId, companyId, body.userId, body.userType, adminId, 'admin');
  }
  ...
  removeAssignee(
    ...
    return this.service.removeTaskAssignee(taskId, assigneeId, companyId, adminId, 'admin');
  }
}
