...
@ApiTags('Employee — Project Planning')
@ApiBearerAuth('employee-jwt')
@UseGuards(JwtEmployeeGuard)
@Controller('employee/projects/:projectId/planning')
export class ProjectPlanningEmployeePlanningController {
  ...
  createTask(
    ...
    return this.service.createTask(projectId, companyId, dto, undefined, employeeId);
  }
  ...
  bulkCreateTasks(
    ...
    return this.service.bulkCreateTasks(projectId, companyId, body.rows, undefined, employeeId);
  }
  ...
  updateTask(
    ...
    return this.service.updateTask(taskId, companyId, dto, undefined, employeeId);
  }
